...
extension FintureSchemeX on ColorScheme {
  ...
  Color get shimmerBase =>
      brightness == Brightness.dark ? const Color(0xFF3A3A3A) : const Color(0xFFE0E0E0);
  Color get shimmerHighlight =>
      brightness == Brightness.dark ? const Color(0xFF4F4F4F) : const Color(0xFFF5F5F5);

  Color get blackOrWhite => brightness == Brightness.dark ? Colors.white : Colors.black;
  ...
  Color get disabled => onSurface.withAlphaOpacity(0.38); // M3 disabled guidance
