...
extension FText on TextStyle {
  ...
  TextStyle onSurfaceVariant(BuildContext c) =>
      copyWith(color: c.colors.onSurfaceVariant);
  ...
  TextStyle onPrimaryContainer(BuildContext c) =>
      copyWith(color: c.colors.onPrimaryContainer);
  TextStyle primaryDark(BuildContext c) => copyWith(color: c.brand.primaryDark);

  // Fine-tuning
  TextStyle size(double v) => copyWith(fontSize: v);
  TextStyle lh(double v) =>
      copyWith(height: v); // line height multiple (e.g., 18/13 = 1.3846)
