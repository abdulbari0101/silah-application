...
TextStyle? vf(TextStyle? base, double w) =>
    base?.copyWith(fontWeight: _fontWeightFor(w));
...
class ExtraLabels extends ThemeExtension<ExtraLabels> {
  ...
  @override
  ExtraLabels copyWith({TextStyle? label5}) =>
      ExtraLabels(label5: label5 ?? this.label5);
  @override
  ThemeExtension<ExtraLabels> lerp(covariant ExtraLabels? other, double t) =>
      this;
}
...
TextTheme buildTextTheme(
  ...
  final baseWithFamily = m3Base.apply(fontFamily: 'Cairo');

  final colored = baseWithFamily.apply(
  ...
  return colored.copyWith(
    ...
    titleMedium: vf(
      colored.titleMedium,
      600,
    )?.copyWith(fontSize: 18, height: 22 / 18),
    titleSmall: vf(
      colored.titleSmall,
      600,
    )?.copyWith(fontSize: 15, height: 22 / 18),

    displaySmall: vf(
      colored.displaySmall,
      600,
    )?.copyWith(fontSize: 36, height: 42 / 36),
    headlineMedium: vf(
      colored.headlineMedium,
      600,
    )?.copyWith(fontSize: 30, height: 36 / 30),
    headlineSmall: vf(
      colored.headlineSmall,
      600,
    ...
    bodyLarge: vf(
      colored.bodyLarge,
      400,
    )?.copyWith(fontSize: 17, height: 25 / 17),
    bodyMedium: vf(
      colored.bodyMedium,
      400,
    ...
    labelLarge: vf(
      colored.labelLarge,
      600,
    )?.copyWith(fontSize: 15, height: 18 / 15),
    labelMedium: vf(
      colored.labelMedium,
      400,
    )?.copyWith(fontSize: 13, height: 18 / 13),
