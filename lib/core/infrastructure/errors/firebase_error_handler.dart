    ...
    switch (e.code) {
      case 'invalid-email':
        return AuthException(
          Strings.error_invalid_email.tr(),
          ErrorCodes.badRequest400,
        );
      case 'user-disabled':
        return AuthException(
          Strings.err_forbidden.tr(),
          ErrorCodes.forbidden403,
        );
      case 'user-not-found':
        return AuthException(
          Strings.err_not_found.tr(),
          ErrorCodes.notFound404,
        );
      case 'wrong-password':
      case 'invalid-credential':
        return AuthException(
          Strings.msg_user_pass_not_correct.tr(),
          ErrorCodes.invalidUserPass11,
        );
      case 'email-already-in-use':
        return AuthException(Strings.err_conflict.tr(), ErrorCodes.conflict409);
      case 'weak-password':
        return AuthException(
          Strings.password_min_length_error.tr(),
          ErrorCodes.unprocessable422,
        );
      case 'operation-not-allowed':
        return ServerException(
          Strings.err_service_unavailable.tr(),
          ErrorCodes.serviceUnavailable503,
        );
      case 'too-many-requests':
        return ServerException(Strings.rate_limited.tr(), 429);
      case 'network-request-failed':
        return NetworkException(
          Strings.err_no_internet_connection.tr(),
    ...
    switch (e.code) {
      ...
      case 'unauthenticated':
        return SessionException(
          Strings.err_unauthorized401.tr(),
          ErrorCodes.unauthorized401,
        );
      case 'not-found':
        return ServerException(
          Strings.err_not_found.tr(),
      ...
      case 'already-exists':
        return ConflictException(
          Strings.err_conflict.tr(),
          ErrorCodes.conflict409,
        );
      case 'invalid-argument':
      case 'failed-precondition':
        return BadRequestException(
          Strings.err_bad_request.tr(),
          ErrorCodes.badRequest400,
        );
