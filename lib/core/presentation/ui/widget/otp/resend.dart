...
import 'package:silah_app/core/domain/enums/otp_resend_state.dart';
...
class ResendCode extends StatefulWidget {
  ...
  const ResendCode({super.key, required this.resendState, this.onTap});
...
class _ResendCodeState extends State<ResendCode> {
  ...
  Widget build(BuildContext context) {
    ...
    final resendState = widget.resendState; // updated from widget every build
