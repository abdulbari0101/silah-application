...
Future<void> initAuth() async {
  // Bloc
  locator.registerLazySingleton(() => LoginBloc(repository: locator(), appStateBloc: locator()));
  ...
  locator.registerLazySingleton<AuthIdentityRepo>(
    () => IdentityRepoImpl(cacheDS: locator(), deviceSerialService: locator(), logger: locator()),
  );
