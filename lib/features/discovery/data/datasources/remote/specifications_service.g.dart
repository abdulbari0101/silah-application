...
part of 'specifications_service.dart';
...
class _SpecificationsService implements SpecificationsService {
  _SpecificationsService(this._dio, {this.baseUrl, this.errorLogger});
