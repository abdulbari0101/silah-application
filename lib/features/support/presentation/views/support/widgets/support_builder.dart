...
import 'package:silah_app/features/support/presentation/views/support/widgets/state/support_loaded.dart';
import 'package:silah_app/features/support/presentation/views/support/widgets/state/support_loading.dart';
        ...
        if (state is DataPaymentError) {
          return _ScrollableState(
            child: CustomeErrorWidget(
              ...
              onRetry: () => context.read<SupportBloc>().add(LoadSupports()),
            ),
          );
        }
            ...
            return _ScrollableState(
              child: EmptyWidget(
                retryWidget: PrimaryButtonWithProgress(
                  ...
                  onTap: () => context.read<SupportBloc>().add(LoadSupports()),
                  isLoading: false,
                ),
              ),
            );
